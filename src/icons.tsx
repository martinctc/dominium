...
export const RoadIcon = makeIcon('road', 'RoadIcon');
export const CrossroadIcon = makeIcon('crossroad', 'CrossroadIcon');
export const RoadBottomToRightIcon = makeIcon('roadBottomToRight', 'RoadBottomToRightIcon');
...
export const MarketIcon = makeIcon('market', 'MarketIcon');
